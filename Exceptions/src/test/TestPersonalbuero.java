...
//										-------------- Mitarbeiter ----------------
		...
		Angestellte a1 = new Angestellte("Max", Year.of(1990), Year.of(2005), 'w'); // darf hinein
		Angestellte a2 = new Angestellte("Paul", Year.of(1989), Year.of(2005), 'w'); // darf hinein
		Angestellte a3 = new Angestellte("Silas", Year.of(1980), Year.of(1995), 'w'); // darf hinein, dann ist quote
																						// false
		Angestellte a4 = new Angestellte("Anton", Year.of(1980), Year.of(2020), 'm'); // jetzt muss wieder eine Frau rein

		@SuppressWarnings("unused")
		Freelancer f1 = new Freelancer("Georg", Year.of(1980), Year.of(2019), 'w', 50, 200);
		Manager man1 = new Manager("Marko", Year.of(1985), Year.of(2000), 'w', 10000);
		Manager man2 = new Manager("Polo", Year.of(1984), Year.of(2000), 'w', 20000);
		Manager man3 = new Manager("Ivan", Year.of(1983), Year.of(2000), 'w', 30000);
		Manager man4 = new Manager("Matija", Year.of(1982), Year.of(2000), 'w', 40000);
		Manager man5 = new Manager("Jeff", Year.of(1981), Year.of(2000), 'm', 50000);
...
//		System.out.println("\nBefore:\n"+p1.toString());
//		p1.sortiereMitarbeiter();
//		p1.sortiereNamen();
//		p1.sortiereAlter();
//		p1.sortiereDienstalter();
//		System.out.println("\nAfter:\n"+p1.toString());		
