...
//										-------------- Mitarbeiter ----------------
		...
		try
		{
			Angestellte a1 = new Angestellte("Paul", Year.of(1990), Year.of(2005), 'w');
			Angestellte a2 = new Angestellte("Paul", Year.of(1989), Year.of(2005), 'w');
			Angestellte a3 = new Angestellte("Paul", Year.of(1980), Year.of(1995), 'w'); // false
			Angestellte a4 = new Angestellte("Paul", Year.of(1980), Year.of(2020), 'm');
